...
class FastNoise2 {
    ...
    public unsafe OutputMinMax GenUniformGrid2D(Span<float> noiseOut,
                                         int xStart,
                                         int yStart,
                                         int xSize,
                                         int ySize,
    ...
    public class Metadata: IFormattable {
        ...
        public string ToString(string? format, IFormatProvider? formatProvider) {
            FormattableString formattable = $"Id: {id}, Name: {name}, Members: {members.join_to_string()}";
    ...
    private const string NATIVE_LIB = "libFastNoise.dylib";
    ...
    [DllImport(NATIVE_LIB)]
    private static extern unsafe uint fnGenUniformGrid2D(IntPtr nodeHandle,
                                                  float* noiseOut,
                                                  int xStart,
                                                  int yStart,
                                                  int xSize,
    ...
    [DllImport(NATIVE_LIB)]
    private static extern uint fnGenUniformGrid3D(IntPtr nodeHandle,
                                                  float[] noiseOut,
                                                  int xStart,
                                                  int yStart,
                                                  int zStart,
    ...
    [DllImport(NATIVE_LIB)]
    private static extern uint fnGenUniformGrid4D(IntPtr nodeHandle,
                                                  float[] noiseOut,
                                                  int xStart,
                                                  int yStart,
                                                  int zStart,
    ...
    [DllImport(NATIVE_LIB)]
    private static extern void fnGenTileable2D(IntPtr node,
                                               float[] noiseOut,
                                               int xSize,
                                               int ySize,
                                               float frequency,
    ...
    [DllImport(NATIVE_LIB)]
    private static extern void fnGenPositionArray2D(IntPtr node,
                                                    float[] noiseOut,
                                                    int count,
                                                    float[] xPosArray,
                                                    float[] yPosArray,
    ...
    [DllImport(NATIVE_LIB)]
    private static extern void fnGenPositionArray3D(IntPtr node,
                                                    float[] noiseOut,
                                                    int count,
                                                    float[] xPosArray,
                                                    float[] yPosArray,
    ...
    [DllImport(NATIVE_LIB)]
    private static extern void fnGenPositionArray4D(IntPtr node,
                                                    float[] noiseOut,
                                                    int count,
                                                    float[] xPosArray,
                                                    float[] yPosArray,
